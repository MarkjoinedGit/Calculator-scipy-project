...
import pygame_gui
import MinimizeCaculator
from ExpressionPlotter import ExpressionPlotter
...
class MinimizeFunction:
    def __init__(self):
        ...
        # buttons
        self.submit_btn = bt.Button(self.screen, self.text_font, 'Submit', 153, 36, (83, 524), False, 30, '#FF9A24', '#F3B771', '#ffffff', '#ffffff')
    ...
    def drawMinimizeFunction(self):
        plotter = ExpressionPlotter(size=(1000, 600))
        while True:
            try:
...
miniFunction = MinimizeFunction()
miniFunction.drawMinimizeFunction()
